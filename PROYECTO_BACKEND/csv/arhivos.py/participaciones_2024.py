...
# Configuración de trimestres para 2024
TRIMESTRES = {
    # Trimestre ID: (nombre, fecha_inicio, fecha_fin)
    10: ("Primer Trimestre 2024", "2024-02-01", "2024-04-30"),
    11: ("Segundo Trimestre 2024", "2024-05-01", "2024-08-31"),
    12: ("Tercer Trimestre 2024", "2024-10-01", "2024-12-20")
}
...
if __name__ == "__main__":
    ...
    # Guardar en CSV
    archivo_salida = os.path.join(os.path.dirname(__file__), 'participaciones_2024.csv')
    guardar_participaciones_csv(participaciones, archivo_salida)
    
    print(f"Se han generado {len(participaciones)} evaluaciones de participación para el año 2024")
