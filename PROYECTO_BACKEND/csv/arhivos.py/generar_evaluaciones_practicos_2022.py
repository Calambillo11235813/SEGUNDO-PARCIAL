...
trimestres = [
    (4, "2022-03-01"),  # Primer trimestre
    (5, "2022-06-01"),  # Segundo trimestre
    (6, "2022-10-01"),  # Tercer trimestre
]

with open("evaluaciones_practicos_2022.csv", "w", newline='', encoding="utf-8") as csvfile:
    fieldnames = [
...
print("Archivo evaluaciones_practicos_2022.csv generado con 3 parciales y 6 prácticos por materia y curso para cada trimestre.")