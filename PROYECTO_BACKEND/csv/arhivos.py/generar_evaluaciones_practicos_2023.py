...
trimestres = [
    (7, "2023-03-01"),  # Primer trimestre
    (8, "2023-06-01"),  # Segundo trimestre
    (9, "2023-10-01"),  # Tercer trimestre
]

with open("evaluaciones_practicos_2023.csv", "w", newline='', encoding="utf-8") as csvfile:
    fieldnames = [
...
print("Archivo evaluaciones_practicos_2023.csv generado con 3 parciales y 6 prácticos por materia y curso para cada trimestre.")