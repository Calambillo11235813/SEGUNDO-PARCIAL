...
evaluaciones = []
with open("evaluaciones_practicos_2022.csv", newline='', encoding="utf-8") as f:
    reader = csv.DictReader(f)
    for row in reader:
...
with open("calificaciones_2022.csv", "w", newline='', encoding="utf-8") as f:
    fieldnames = [
        "estudiante_codigo",
        "estudiante_nombre",
        "estudiante_apellido",
...
print("Archivo calificaciones_2022.csv generado correctamente con notas para cada estudiante y evaluación.")
