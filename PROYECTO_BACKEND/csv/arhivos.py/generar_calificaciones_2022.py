...
# Agregar instalación condicional de numpy si no está instalado
try:
...
def main():
    print("🚀 Iniciando generación de calificaciones 2022 con distribución realista...")
    ...
    evaluaciones = []
    eval_path = os.path.join(csv_dir, "evaluaciones_practicos_2022.csv")
    ...
    output_path = os.path.join(csv_dir, "calificaciones_2022.csv")
