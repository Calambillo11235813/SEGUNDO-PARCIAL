...
evaluaciones = []
with open("evaluaciones_practicos_2023.csv", newline='', encoding="utf-8") as f:
    reader = csv.DictReader(f)
    for row in reader:
...
with open("calificaciones_2023.csv", "w", newline='', encoding="utf-8") as f:
    fieldnames = [
        "estudiante_codigo",
        "estudiante_nombre",
        "estudiante_apellido",
...
print("Archivo calificaciones_2023.csv generado correctamente con notas para cada estudiante y evaluación.")
